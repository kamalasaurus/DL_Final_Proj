...
if __name__ == "__main__":
    ...
    scheduler = optim.lr_scheduler.CosineAnnealingLR(optimizer, T_max=len(train_loader) * 20, eta_min=lr*0.1)
    
    # Checkpoint path
    checkpoint_path = "/scratch/fc1132/JEPA_world_model/encoder_outputs/trained_recurrent_jepa_512.pth"
    ...
    for epoch in range(start_epoch, total_epochs):
        ...
        for step, (states, actions) in enumerate(tqdm(train_loader, desc=f"Epoch {epoch+1}/{total_epochs}")):
    ...
    plt.grid(True)
    plt.savefig('/scratch/fc1132/JEPA_world_model/plots/training_loss_512_continued.png')
    #plt.show()
    # Save the trained model
    torch.save(model.state_dict(), "/scratch/fc1132/JEPA_world_model/encoder_outputs/trained_recurrent_jepa_512_continued.pth")
