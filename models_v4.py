...
if __name__ == "__main__":
    ...
    plt.grid(True)
    plt.savefig('/scratch/fc1132/JEPA_world_model/plots/training_loss_U.png')
    #plt.show()
    # Save the trained model
    torch.save(model.state_dict(), "/scratch/fc1132/JEPA_world_model/encoder_outputs/trained_recurrent_jepa_U.pth")
