...
```
!python -m torch.distributed.launch --nproc_per_node=8 /content/vicreg/main_vicreg.py --data-dir /content/data --exp-dir /content/data --arch JEPAEncoder --epochs 2 --batch-size 512 --base-lr 0.3
```
